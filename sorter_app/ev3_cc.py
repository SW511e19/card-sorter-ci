...
def cc(current_box, box_offset, speed, secs_skip_looking):
    calibration_color = colorsensor.COLOR_RED
    is_box_color = True
    look_for_box = False
...
def cc_one_color(current_box, box_offset, speed, secs_skip_looking):
    calibration_color = colorsensor.COLOR_RED
    is_box_color = True
    look_for_box = False
    box_color = colorsensor.color
...
def go_to_box(current_box, dest_box, speed, secs_skip_looking):
...
def go_to_box2(current_box, dest_box, speed, secs_skip_looking):
    if (dest_box == current_box):
        print("Was already at box")
    if dest_box > current_box:
